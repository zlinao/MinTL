...
class MiniT5(MT5ForConditionalGeneration):
    def __init__(self, config):
        ...
        self.decoder = type(self.decoder)(decoder_config, self.shared)
        self.decoder.load_state_dict(self.decoder.state_dict())
        self.lm_head = type(self.lm_head)(config.d_model, config.vocab_size, bias=False)
        self.lm_head.load_state_dict(self.lm_head.state_dict())
    ...
    def tie_decoder(self):
        ...
        self.decoder = type(self.decoder)(decoder_config, self.shared)
        self.decoder.load_state_dict(self.decoder.state_dict())
        self.lm_head = type(self.lm_head)(self.config.d_model, self.config.vocab_size, bias=False)
        self.lm_head.load_state_dict(self.lm_head.state_dict())
